        ...
        <Tabs defaultValue="discussions" className="space-y-6">
          ...
          <TabsContent value="discussions" className="space-y-6">
            <div className="grid lg:grid-cols-4 gap-6 h-[700px]">
              {/* Discussion List */}
              <Card className="kmrl-card lg:col-span-1">
                ...
                <CardContent className="p-0 flex-1 overflow-hidden">
                  <div className="space-y-1 max-h-full overflow-y-auto">{discussions.map((discussion) => (
                      <div
                        key={discussion.id}
                        className={`p-3 cursor-pointer hover:bg-muted/50 transition-colors border-l-2 ${
                          selectedChat === discussion.id ? "bg-primary/10 border-l-primary" : "border-l-transparent"
                        }`}
              ...
              {/* Chat Area */}
              <Card className="kmrl-card lg:col-span-3 flex flex-col">
                  ...
                  {messages.map((message) => (
                    <div key={message.id} className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-card-foreground leading-relaxed break-words">
                          {message.content}
                        </p>
                        ...
                        {message.attachments.length > 0 && (
                          <div className="mt-2 space-y-1">
                            {message.attachments.map((attachment, index) => (
                              <div key={index} className="flex items-center space-x-2 p-2 bg-muted/50 rounded text-xs">

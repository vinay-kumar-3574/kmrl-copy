...
const Dashboard = () => {
  ...
  const sectorData = {
    ...
    finance: {
      ...
      stats: [
        { title: "Budget Items", value: "156", change: "+12", icon: FileText, color: "text-primary" },
        { title: "Finance Team", value: "28", change: "+2", icon: Users, color: "text-success" },
        { title: "Overdue Payments", value: "7", change: "-3", icon: AlertTriangle, color: "text-destructive" },
        { title: "Pending Approvals", value: "15", change: "+4", icon: Clock, color: "text-warning" },
      ],
      recentActivities: [
        { title: "Budget Report Generated", time: "1 hour ago", type: "document" },
        { title: "Vendor Payment Processed", time: "3 hours ago", type: "completed" },
        { title: "Audit Documentation Updated", time: "5 hours ago", type: "upload" },
        { title: "Quarterly Review Meeting", time: "1 day ago", type: "meeting" },
      ]
    },
    procurement: {
      title: "Procurement Dashboard", 
      stats: [
        { title: "Active Contracts", value: "89", change: "+7", icon: FileText, color: "text-primary" },
        { title: "Procurement Team", value: "32", change: "+1", icon: Users, color: "text-success" },
        { title: "Urgent Requests", value: "5", change: "-2", icon: AlertTriangle, color: "text-destructive" },
        { title: "Vendor Reviews", value: "12", change: "+3", icon: Clock, color: "text-warning" },
      ],
      recentActivities: [
        { title: "New Vendor Registration", time: "30 minutes ago", type: "document" },
        { title: "Purchase Order Approved", time: "2 hours ago", type: "completed" },
        { title: "Contract Terms Updated", time: "4 hours ago", type: "upload" },
        { title: "Supplier Evaluation Complete", time: "6 hours ago", type: "meeting" },
      ]
    }
  };

  const currentData = sector ? sectorData[sector as keyof typeof sectorData] : null;
